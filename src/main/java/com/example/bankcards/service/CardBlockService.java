...
public interface CardBlockService {
    CardBlockResponseDto create(String login, CardBlockRequestDto cardBlockRequestDto);
    Page<CardBlockResponseDto> getAll(Pageable pageable);
    Page<CardBlockResponseDto> getAllRequestByUserLogin(String login, Pageable pageable);
    CardBlockResponseDto getById(Long id);
    CardBlockResponseDto getUserRequestById(String login, Long id);
